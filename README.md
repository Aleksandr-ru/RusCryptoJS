...
- Проверка валидности сертификата через СКЗИ Крипто-ПРО может занимать продолжительное время при недоступности серверов cryptopro.ru (по-умолчанию отключено начиная с версии библиотеки 2.7)
